package org.awesley.digital.customservice.application;
...
import org.awesley.digital.customservice.config.TestConfiguration;
...
public class RestTemplateTest {
	...
	public void canLoadEntity1() {
		ResponseEntity<Entity1> entity = testRestTemplate.getForEntity("http://localhost:" + this.port + "/coreservice-service/entity1/1", Entity1.class);
